        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousGroupChatId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GroupChannelName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultSpaceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalChatId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChannelIdentities_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembershipPermissions", x => new { x.MembershipId, x.Resource });
                    table.ForeignKey(
                        name: "FK_MembershipPermissions_Memberships_MembershipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelIdentities_ChannelName_ExternalUserId",
                table: "ChannelIdentities",
                columns: new[] { "ChannelName", "ExternalUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChannelIdentities_UserId",
                table: "ChannelIdentities",
                column: "UserId");
