        ...
        foreach (var spaceId in spaceIds)
        {
            ...
            foreach (var memberId in memberIds)
            {
                ...
                foreach (var e in events)
                {
                    ...
                    if (await calendarQuery.WasNotifiedAsync(spaceId, memberId, eventKey, e.Start, ct))
                    {
                        continue;
                    }
                    ...
                    {
                        await calendarQuery.RecordNotifiedAsync(spaceId, memberId, eventKey, e.Start, ct);
                        continue;
                    }
